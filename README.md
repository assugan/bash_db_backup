...
Функция check_requirements проверяет:
	• наличие утилит psql, pg_dump, tar, gzip;
...
Алгоритм:
	1. Находит все архивы по маске pg_backup_*.tar.gz
	2. Сортирует по времени создания
	3. Удаляет самые старые (если их больше заданного лимита)
